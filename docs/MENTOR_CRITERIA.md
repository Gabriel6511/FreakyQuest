...
- ✅ **12º mentor: Anya Forger** (`anya`, universo novo `Spy x Family`, `genetics`, FOC/AGI, tema rosa "Waku Waku"). Falas fiéis usam ganchos reais do anime (telepatia, Estrela Stella/Tonitrus Bolt do sistema de notas da Eden Academy, "Anya wa tensai", medo de causar "GUERRA", Chichi/Bondman) — não frases genéricas.
  ...
  - 4 itens propostos (ainda sem ícone, ver `docs/PROMPTS_ITENS_MENTORES.md`): Estrela Stella (Nv5·Insígnia), Laços Cor-de-Rosa (Nv15·Cabeça), Aura Telepática (Nv30·Aura), **Minduim da Anya** (Nv4·Punhos — item bônus pedido explicitamente pelo usuário, referência à fala clássica dela sobre amendoim; existe só pra Anya, nenhum outro mentor tem 4 itens).
