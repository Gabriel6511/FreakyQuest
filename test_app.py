...
def run_tests():
    ...
    with sync_playwright() as p:
        ...
        if page.locator("#onboarding-wizard").is_visible():
            ...
            # Step 8b: Idade (Avanca com botao)
            print("Etapa 8b: Idade")
            page.click("#wiz-btn-next")
            time.sleep(0.3)
        ...
        # 3. Pular Tutorial se estiver aberto (pode demorar devido a timeouts no JS)
        try:
            ...
            print("Tutorial overlay não apareceu ou já foi pulado.")
